                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapsePosts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ route('posts.store') }}">List post</a>
                                    <a class="nav-link" href="{{ route('posts.create') }}">New post</a>
                                </nav>
                            </div>

                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapsePortfolios" aria-expanded="false" aria-controls="collapsePortfolios">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Portfolios
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="collapsePortfolios" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="post-sidenav-light.html">List portfolio</a>
                                    <a class="nav-link" href="post-static.html">New portfolio</a>
                                </nav>
                            </div>
